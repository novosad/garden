...
<!--                <span class="post-info-comments"><a-->
<!--                        href="--><?php //comments_link(); ?><!--">--><?php //printf(_n('1 Comment', '%1$s Comments', get_comments_number(), 'minezine'), number_format_i18n(get_comments_number()), get_the_title()); ?><!--</a></span>-->
<!--            --><?php //endif; ?>
<!--        </p>-->
<!--        <div class="post-info">-->
...
<!--        </div>-->
    ...
    <?php
    //edit_post_link(__('Edit', 'minezine'), '<p>', '</p>');
    ?>
<?php endwhile; endif; ?>
