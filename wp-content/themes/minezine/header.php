...
<div id="container">
    ...
    <header id="header">
                ...
                <div id="top-navigation-wrapper">
                    <div class="top-navigation">
                        <?php if (has_nav_menu('top-navigation')) {
                            wp_nav_menu(array('menu_id' => 'top-nav', 'theme_location' => 'top-navigation'));
                        } ?>
                            ...
                            <div class="header-icons">
                                <?php if ($minezine_options_db['minezine_header_facebook_link'] != '') { ?>
                                    <a class="social-icon facebook-icon" target="_blank"
                                       href="<?php echo esc_url($minezine_options_db['minezine_header_facebook_link']); ?>"></a>
                                <?php } ?>
                                <?php if ($minezine_options_db['minezine_header_twitter_link'] != '') { ?>
                                    <a class="social-icon twitter-icon" target="_blank"
                                       href="<?php echo esc_url($minezine_options_db['minezine_header_twitter_link']); ?>"></a>
                                <?php } ?>
                                <?php if ($minezine_options_db['minezine_header_google_link'] != '') { ?>
                                    <a class="social-icon google-icon" target="_blank"
                                       href="<?php echo esc_url($minezine_options_db['minezine_header_google_link']); ?>"></a>
                                <?php } ?>
                                <?php if ($minezine_options_db['minezine_header_rss_link'] != '') { ?>
                                    <a class="social-icon rss-icon" target="_blank"
                                       href="<?php echo esc_url($minezine_options_db['minezine_header_rss_link']); ?>"></a>
                                <?php } ?>
                            </div>
                        <?php } ?>
                    </div>
        ...
        <div class="header-content">
            ...
            <?php } else { ?>
                <a href="<?php echo esc_url(home_url('/')); ?>"><img class="header-logo"
                                                                     src="<?php echo esc_url($minezine_options_db['minezine_logo_url']); ?>"
